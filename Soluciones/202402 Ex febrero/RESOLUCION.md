...
Ver Guía sección 6 — mismo desarrollo (Aporte Unificado Ley 14.411, Convenio Colectivo Grupo 37 tripartito) que en `Soluciones/202302 Ex Febrero/` (parte IV), `Soluciones/202307 Ex Julio/` (parte VI), `Soluciones/202312 Ex diciembre/` (parte VI) y `Soluciones/202003 Ex Marzo/` (parte IV): validación cruzada indirecta entre 5 exámenes distintos, todos consistentes entre sí.
