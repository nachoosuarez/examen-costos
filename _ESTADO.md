# Estado del trabajo — Costos (actualizado: corrida del 23/07/2026 — 16ª pasada)

## Resumen ejecutivo (leer esto primero)
1. Van 18 exámenes con resolución escrita: **Enero 2026** (parcial), **Diciembre 2025**, **Julio 2025**, **Marzo 2025**, **Febrero 2025**, **Diciembre 2024**, **Julio 2024**, **"Marzo 2024"** (real 20/02/2024), **Febrero 2024** (real 30/01/2024), **Diciembre 2023**, **Julio 2023**, **"Marzo 2023"** (real 16/02/2023), **Febrero 2023** (real 26/01/2023), **Diciembre 2022**, **Julio 2022**, **"Marzo 2022"** (real 15/02/2022), **Febrero 2022** (real 26/01/2022) y **Diciembre 2021** — los últimos 17 completos (I y II verificadas en Dic-2021, teóricas III-V con criterio de la Guía). Faltan 6 exámenes más viejos (2019-2020).
...
4. **Diciembre 2025, Julio 2025, Marzo 2025, Febrero 2025, Diciembre 2024, Julio 2024, "Marzo 2024", Febrero 2024, Diciembre 2023, Julio 2023, "Marzo 2023", Febrero 2023, Diciembre 2022, Julio 2022, "Marzo 2022", Febrero 2022 y Diciembre 2021** están resueltos (las partes con solución oficial en el repo, verificadas exactamente; las teóricas puntuales sin solución oficial se respondieron con el criterio de la Guía).
5. **Diciembre 2021** (único con solución oficial parcial, solo I-II) trajo un ejercicio de excavación con talud + fórmula de tronco de pirámide muy claro: **un mismo volumen "en banco" responde 3 preguntas distintas del enunciado usando 3 coeficientes distintos** (Ce para transportar fuera de obra, Ca para relleno compactado en otro lugar, Cc para material sobre camión que rellena la propia excavación) — ejemplo de referencia para cualquier ejercicio de movimiento de suelos con múltiples preguntas sobre el mismo volumen. También trae el conjunto pilar circular+zapata con ensanche de sección (fuste Ø0,70→Ø0,80) y un costo de equipo (retroexcavadora) que confirma la fórmula de interés sobre capital medio ya vista en Feb-2025. Ver Guía sección 13.
...
| 202012 Dic 2020 | ⬜ Pendiente | **Siguiente a resolver.** |
