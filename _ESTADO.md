# Estado del trabajo — Costos (actualizado: corrida del 23/07/2026 — 15ª pasada)

## Resumen ejecutivo (leer esto primero)
1. Van 17 exámenes con resolución escrita: **Enero 2026** (parcial), **Diciembre 2025**, **Julio 2025**, **Marzo 2025**, **Febrero 2025**, **Diciembre 2024**, **Julio 2024**, **"Marzo 2024"** (real 20/02/2024), **Febrero 2024** (real 30/01/2024), **Diciembre 2023**, **Julio 2023**, **"Marzo 2023"** (real 16/02/2023), **Febrero 2023** (real 26/01/2023), **Diciembre 2022**, **Julio 2022**, **"Marzo 2022"** (real 15/02/2022) y **Febrero 2022** (real 26/01/2022) — los últimos 16 completos y verificados contra solución oficial. Faltan 7 exámenes más viejos (2019-2021).
...
4. **Diciembre 2025, Julio 2025, Marzo 2025, Febrero 2025, Diciembre 2024, Julio 2024, "Marzo 2024", Febrero 2024, Diciembre 2023, Julio 2023, "Marzo 2023", Febrero 2023, Diciembre 2022, Julio 2022, "Marzo 2022" y Febrero 2022** están 100% resueltos y verificados contra solución oficial (encontrada en el propio PDF de la letra de cada examen, en un segundo archivo con la planilla de cálculo ya completada; algunas partes teóricas puntuales sin solución oficial se respondieron con el criterio de la Guía).
5. **Febrero 2022** (el examen más viejo de la serie 2022, primero cronológicamente de ese año) trajo una viga de sección compuesta tipo "T invertida asimétrica" con 3 perfiles de estribo distintos (mismo criterio que Marzo-2024 para geometría compuesta ambigua: usar los valores de la planilla oficial validando el volumen), y repitió el patrón de garantías con Monto Imponible "a estimar" (80%/75,8% LLSS) ya visto en Jul-2022 — sin variantes nuevas en Garantías. Ver Guía sección 1.
...
| 202112 Dic 2021 | ⬜ Pendiente | **Siguiente a resolver.** Tiene solución oficial parcial (I y II). |
