# Estado del trabajo — Costos (actualizado: corrida del 23/07/2026 — 18ª pasada)

## Resumen ejecutivo (leer esto primero)
1. Van 20 exámenes con resolución escrita: **Enero 2026** (parcial), **Diciembre 2025**, **Julio 2025**, **Marzo 2025**, **Febrero 2025**, **Diciembre 2024**, **Julio 2024**, **"Marzo 2024"** (real 20/02/2024), **Febrero 2024** (real 30/01/2024), **Diciembre 2023**, **Julio 2023**, **"Marzo 2023"** (real 16/02/2023), **Febrero 2023** (real 26/01/2023), **Diciembre 2022**, **Julio 2022**, **"Marzo 2022"** (real 15/02/2022), **Febrero 2022** (real 26/01/2022), **Diciembre 2021**, **Diciembre 2020** y **Julio 2020** (real 11/08/2020) — los últimos 19 completos (partes con solución oficial verificadas exactas, teóricas con criterio de la Guía). Faltan 4 exámenes más viejos (2019-2020).
...
4. **Diciembre 2025, Julio 2025, Marzo 2025, Febrero 2025, Diciembre 2024, Julio 2024, "Marzo 2024", Febrero 2024, Diciembre 2023, Julio 2023, "Marzo 2023", Febrero 2023, Diciembre 2022, Julio 2022, "Marzo 2022", Febrero 2022, Diciembre 2021, Diciembre 2020 y Julio 2020** están resueltos (las partes con solución oficial en el repo, verificadas exactamente; las teóricas puntuales sin solución oficial se respondieron con el criterio de la Guía).
5. **Julio 2020** (solución oficial completa I-III) trajo un tipo de ejercicio **NUEVO en Punto de Equilibrio**: extensión de plazo pedida **antes de iniciar la obra** (no a mitad de camino como Dic-2022), con una fórmula de reconocimiento muy simple `re=cfo×inc` (independiente del plazo y del beneficio originales), y un giro adicional: el contratista logra un ahorro propio de costo fijo que el cliente no conoce, terminando con un margen real (19,64%) por encima del pactado (15%). También confirmó otra vez el patrón losa-suspendida-4-lados (Tenor=1/e) con doble capa de armado. Ver Guía sección 11.
...
| 202003 Marzo 2020 | ⬜ Pendiente | **Siguiente a resolver.** |
