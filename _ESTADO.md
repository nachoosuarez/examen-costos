# Estado del trabajo — Costos (actualizado: corrida del 23/07/2026 — 20ª pasada)

## Resumen ejecutivo (leer esto primero)
1. Van 22 exámenes con resolución escrita: **Enero 2026** (parcial), **Diciembre 2025**, **Julio 2025**, **Marzo 2025**, **Febrero 2025**, **Diciembre 2024**, **Julio 2024**, **"Marzo 2024"** (real 20/02/2024), **Febrero 2024** (real 30/01/2024), **Diciembre 2023**, **Julio 2023**, **"Marzo 2023"** (real 16/02/2023), **Febrero 2023** (real 26/01/2023), **Diciembre 2022**, **Julio 2022**, **"Marzo 2022"** (real 15/02/2022), **Febrero 2022** (real 26/01/2022), **Diciembre 2021**, **Diciembre 2020**, **Julio 2020** (real 11/08/2020), **Marzo 2020** (real 18/02/2020) y **Febrero 2020** (real 29/01/2020) — los últimos 21 completos (partes con solución oficial verificadas exactas, teóricas con criterio de la Guía). Faltan 2 exámenes más viejos (2019).
...
4. **Diciembre 2025, Julio 2025, Marzo 2025, Febrero 2025, Diciembre 2024, Julio 2024, "Marzo 2024", Febrero 2024, Diciembre 2023, Julio 2023, "Marzo 2023", Febrero 2023, Diciembre 2022, Julio 2022, "Marzo 2022", Febrero 2022, Diciembre 2021, Diciembre 2020, Julio 2020, Marzo 2020 y Febrero 2020** están resueltos (las partes con solución oficial en el repo, verificadas exactamente; las teóricas puntuales sin solución oficial se respondieron con el criterio de la Guía).
5. **Febrero 2020** (planilla oficial de A, B y D) trajo un tipo **NUEVO** en Punto de Equilibrio: la variante inversa a la de Dic-2024 — en vez de hallar el precio para que el equilibrio caiga a un % de capacidad dado, acá se pide el % de reducción del costo fijo necesario para DESPLAZAR el equilibrio de un % de capacidad a otro (manteniendo precio y costo variable fijos); la relación es directamente proporcional: `CF_nuevo=CF×(Q_objetivo/Q_original)`. También metraje de una pieza prefabricada con croquis rotado ambiguo (resuelto con planilla oficial, mismo criterio que Marzo-2024/Feb-2022) y fórmula paramétrica con 4 repartos válidos entre CV y Dólar. Ver Guía sección 11.
6. **Marzo 2020** (planilla oficial completa I-III, embebida en el propio PDF de la letra) trajo dos tipos **NUEVOS**: en Metraje, un muro de contención armado con una sola barra en "horquilla" (pata+pantalla doblada en una pieza, en vez de 2 familias separadas) y encofrado a una sola cara por ejecutarse con taludes verticales de trinchera; en Garantías, un anticipo con devolución escalonada en 4 tramos discretos (en vez de rampa continua). También trajo el mismo patrón de Dic-2023 (flujo con anticipo + elección de línea de crédito), con un atajo útil: se puede descartar una línea de crédito por el déficit SIN intereses antes de calcular el interés compuesto. Ver Guía secciones 1, 7 y 12.
7. El resumen teórico cubre **5 clases completas** (Clase 2, 3, 9, 19, 20) + Equipos.pdf; quedan 12 clases sin resumir todavía (ver lista abajo).
8. Prioridad para la próxima corrida: seguir con **Diciembre 2019** hacia atrás (quedan 2 exámenes: Dic-2019 tiene solución oficial completa "Respuestas", Jul-2019 tiene parcial de preguntas A,B,C,D,E); una vez agotados los exámenes disponibles (llegando a 2019), dedicar tiempo completo a enriquecer el resumen teórico (quedan 12 clases sin resumir) y a pulir/revisar la guía de ejercicios tipo de punta a punta.
...
| 201912 Dic 2019 | ⬜ Pendiente | **Siguiente a resolver.** Tiene solución oficial ("Respuestas"). |
